...
const Home = () => {
  ...
  const handleAddQuestion = async () => {
    try {
      const question = {
        title: testQuestions[1].title,
        categories: testQuestions[1].categories,
        complexity: testQuestions[1].complexity,
        description: testQuestions[1].description,
      };
  ...
  const handleDeleteQuestion = async () => {
    try {
      const id = '64fca2c37c256d9f69577760';
  ...
  const handleEditQuestion = async () => {
    try {
      const id = '64fca5e57c256d9f69577762';
      const updatedQuestion = {
        id,
        title: 'Updated title for question 2',
      };
      const response = await patch(updatedQuestion);
      const json = await response.json();
      console.log(json);
    } catch (e) {
      console.log(e);
